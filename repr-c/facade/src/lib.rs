...
//!
//! ```rust
//! # use repr_c::layout::{Type, Annotation, Record, RecordKind, RecordField, TypeVariant, BuiltinType, TypeLayout, FieldLayout};
//! # use repr_c::{compute_layout, Target};
//! let ty = Type::<()> {
//!     layout: (),
...
pub use repr_c_impl::result::{Error, ErrorType};

pub mod visitor {
    //! Types and functions allowing you to traverse a [`Type`](crate::layout::Type).

    pub use repr_c_impl::visitor::Visitor;

    pub use repr_c_impl::visitor::{
